...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-auto">
                                            <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $siswa }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <!-- Pie Chart -->
            <div class="col-xl-4 col-md-6 float-left mb-4">
            ...
            <div class="col-xl-4 col-lg-5">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Data Lunas</h6>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
